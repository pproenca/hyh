...
from harness.client import get_socket_path, get_worker_id
...
class TestWorkerIdPersistence:
    ...
    def test_worker_id_format(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch.dict(os.environ, {"HARNESS_WORKER_ID_FILE": str(worker_file)}):
...
class TestSocketPathGeneration:
    ...
    def test_socket_path_format(self) -> None:
        ...
        with (
            ...
            patch.dict(os.environ, {"HARNESS_WORKTREE": tmpdir}),
        ):
            socket_path = get_socket_path()

            assert socket_path.endswith(".sock")
            assert "harness" in socket_path.lower()
    ...
    def test_socket_path_different_worktrees(self) -> None:
        ...
        NOTE: HARNESS_WORKTREE env var may not directly affect get_socket_path().
